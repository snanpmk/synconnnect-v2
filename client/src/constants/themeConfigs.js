export const themeConfigs = {
  ...
  // 🩵 Minimal Light — clean blue gradient
  minimalLight: {
  ...
  // 🌙 Minimal Dark — subtle gray gradient
  minimalDark: {
  ...
  // 🌿 Minimal Green — nature-inspired gradient
  minimalGreen: {
  ...
  // 💜 Minimal Purple — soft lilac gradient
  minimalPurple: {
  ...
  // 🌌 Midnight Blue — dark gradient elegance
  midnightBlue: {
  ...
  // 🌸 Soft Pink — pastel pink gradient
  softPink: {
  ...
  // 🌊 Ocean Blue — fresh aqua gradient
  oceanBlue: {
  ...
  // ☕ Warm Brown — creamy neutral gradient
  warmBrown: {
  ...
  // 💜 Indigo Night — deep indigo gradient
  indigoNight: {
  ...
  // 🌲 Forest Green — deep earthy gradient
  forestGreen: {
